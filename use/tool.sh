...
init_easynode() {
    ...
    docker run -d --name easynode --restart unless-stopped \
        ...
        crpi-pqqbvdf8c8dv7tyr.cn-shanghai.personal.cr.aliyuncs.com/nas-mp/easynode:latest
}
...
init_photopea() {
    ...
    docker run -d --name photopea --restart unless-stopped --privileged \
        -p 58081:8887 \
        crpi-pqqbvdf8c8dv7tyr.cn-shanghai.personal.cr.aliyuncs.com/nas-mp/photopea:1.0
}
init_myip() {
    echo "初始化 myip "
